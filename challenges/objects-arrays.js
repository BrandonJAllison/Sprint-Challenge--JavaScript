...
for (let i = 0; i <graduates.length; i++){
    ...
    universitites = universities.sort()
}
...
const animalNames = [];
  zooAnimals.forEach((currentValue) => {
    return (animalNames.push(`Name: ${currentValue.animal_name},  Scientifit: ${currentValue.scientific_name}`));
  })
...
const populationTotal = zooAnimals.reduce((accumulator, currentValue) => {
  return (currentValue.population + accumulator);
},0)
